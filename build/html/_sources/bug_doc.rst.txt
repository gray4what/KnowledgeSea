...
Record the bugs met in Documentation.



RST cheat sheet: referred from: `cheat_sheet <https://github.com/ralsina/rst-cheatsheet/blob/master/rst-cheatsheet.rst>`_ 
================================================================================================================================
...
|                                                               |                                                             |
|   .. image:: ./_images/mult_head.png                          |   .. image:: ./_images/mult_head.png                        |
...
|                                                               |                                                             |
|   .. |biohazard| image:: ./_images/mult_head.png              |   .. |biohazard| image:: ./_images/mult_head.png            |
...
1. Images cannot display on html, but shows correctly on Github source.
    * Solution:  Removed extra .DS_store files and rebuild.   (solve the problem, not sure the cause)
